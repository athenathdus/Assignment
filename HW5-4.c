...
* 마이키보드와 마이 스폐셜 함수 그리고 아이들 함수를 통해 방향키와 특정 문자를 누르면 증가 또는 감소 할 수 있도록 하였다.
/*                                                                                             */
/*******************************************************************************************************************/
...
// 아이들을 사용하여 연속적으로 0.1 씩 증가 또는 감소 하게 만들었음
...
void MyKeyboard(unsigned char key, int x, int y) {  //해당 문자를 눌렀을때 아이들을 부름
    switch (key) {
    case 'a':case 'A':
...
void MySpecial(int key, int x, int y) {  //방향키를 눌렀을때 아이들을 부름
    switch (key) {
    case GLUT_KEY_UP:
